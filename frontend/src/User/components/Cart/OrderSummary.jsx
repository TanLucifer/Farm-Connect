...
function OrderSummary() {
  const [items, setItems] = useState([
    // Example static items. Replace with actual data as needed.
    { title: "Item 1", total: 150.0 },
    { title: "Item 2", total: 200.0 },
    { title: "Item 3", total: 100.0 },
  ]);
  ...
  const shipping = calculateShipping(itemsTotal, shippingThreshold, shippingRate);
