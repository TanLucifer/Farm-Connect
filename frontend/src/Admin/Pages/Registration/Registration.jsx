...
import FileInput from '../../components/Registration/FileInput';
 ...
 return (
   <div className='bg-[#fff5edff]'>
     <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 bg-white shadow-lg rounded-lg mt-1 mb-3 ">
       <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-center text-gray-800 mt-[17vh]">Registration Form</h1>
