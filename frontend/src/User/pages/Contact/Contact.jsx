      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="bg-[#fffac4ff] p-4 transition-all duration-300 hover:bg-gray-200">
          ...
          <div className="bg-[#fffac4ff] p-4 mb-4 transition-all duration-300 hover:bg-gray-200">
            <div className="flex items-center mb-2">
        ...
        <div>
          ...
          <form onSubmit={handleSubmit}> {/*handling submission */}
            ...
            <button type="submit" className="bg-[#ebb207ff] text-black px-4 py-2 rounded mb-[5vh]">Send Message</button>
            </form>
        </div>
      </div>
    </div>
