...
const CartIcon = ({ collapsed }) => {
  // Mocked cart items, replace with actual data fetching if needed
...
const WishlistIcon = ({ collapsed }) => {
  // Mocked wishlist items, replace with actual data fetching if needed
...
const Aside = () => {
  ...
  return (
    <>
      <aside
        className={`bg-[#151c1fff] text-white flex flex-col fixed top-0  ${
          collapsed ? "w-20" : "w-64"
