...
const ConfirmationPage = () => {
  return (
    <div className="min-h-screen bg-[#fffde8ff] flex flex-col items-center justify-center">
      <main className="bg-[#fffac4ff] p-10 rounded-lg shadow-lg text-center max-w-3xl mx-auto" style={{border:'4px solid #605d61ff'}}>
        <div className="">
        ...
        <p className="text-gray-700 mb-6 relative"style={{top:'-5vh'}}>
          ...
          <NavLink  to="/" className="text-green-700 underline ml-1">FarmConnect homepage</NavLink>.
